      ...
      >
        <div className="bg-white h-fit transition-all duration-300 w-full">
          <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
            <h3 className="text-[#42b9be]  text-3xl font-semibold text-center mb-1">
            ...
            <form className="flex flex-col gap-5 my-5">
              ...
              <div>
                <Link
                  ...
                  className="bg-[#42b9be] flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300 hover:bg-[#b8381e]"
                  target="_blank"
                >
                  Payment Proof (SS)
                </Link>
